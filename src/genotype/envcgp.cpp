...
DEFINE_GENOME_DISTANCE_WEIGHTS({
  DISTANCE_WEIGHT(t_a0, .1f),
  DISTANCE_WEIGHT(t_m0, .1f),
  DISTANCE_WEIGHT(t_s0, .1f),
  DISTANCE_WEIGHT(t_a1, .1f),
  DISTANCE_WEIGHT(t_m1, .1f),
  DISTANCE_WEIGHT(t_s1, .1f),
  DISTANCE_WEIGHT( h_a, .1f),
  DISTANCE_WEIGHT( h_f, .1f),
  DISTANCE_WEIGHT( w_m, .1f),
  DISTANCE_WEIGHT( w_s, .1f),
